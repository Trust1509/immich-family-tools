...
const translations = {
  ...
  nav_manual: { de: "Manuell matchen", en: "Manual Match", "pt-BR": "Correspondência Manual", "es-ES": "Coincidencia manual" },
  nav_albums: { de: "Alben", en: "Albums", "pt-BR": "Álbuns", "es-ES": "Álbumes" },
  nav_log: { de: "Sync Log", en: "Sync Log", "pt-BR": "Sync Log", "es-ES": "Registro de sincronización" },
  nav_extend: { de: "Match erweitern", en: "Extend Match", "pt-BR": "Estender Correspondência", "es-ES": "Ampliar coincidencia" },
  app_subtitle: {
  ...
  auth_token_ph: { de: "Zugriffstoken", en: "Access token", "pt-BR": "Token de acesso", "es-ES": "Token de acceso" },
  auth_checking: { de: "Prüfe…", en: "Checking…", "pt-BR": "Verificando…", "es-ES": "Comprobando…" },
  ...
  search_name: { de: "Name suchen…", en: "Search name…", "pt-BR": "Buscar nome…", "es-ES": "Buscar por nombre…" },
  processing: { de: "Wird verarbeitet…", en: "Processing…", "pt-BR": "Processando…", "es-ES": "Procesando…" },
  syncing: { de: "Synchronisiert…", en: "Syncing…", "pt-BR": "Sincronizando…", "es-ES": "Sincronizando…" },
  running: { de: "Wird ausgeführt…", en: "Running…", "pt-BR": "Executando…", "es-ES": "Ejecutando…" },
  ...
  account_add: { de: "Account hinzufügen", en: "Add Account", "pt-BR": "Adicionar Conta", "es-ES": "Añadir cuenta" },
  account_add_title: { de: "Account hinzufügen", en: "Add Account", "pt-BR": "Adicionar Conta", "es-ES": "Añadir cuenta" },
  account_remove_tip: { de: "Account entfernen", en: "Remove account", "pt-BR": "Remover Conta", "es-ES": "Eliminar cuenta" },
  ...
  account_name_ph: { de: "Name (z.B. Manu)", en: "Name (e.g. Manu)", "pt-BR": "Nome (ex. Manu)", "es-ES": "Nombre (p. ej., Manu)" },
  account_test: {
    de: "Teste Verbindung…",
  ...
  account_edit_title: { de: "Account bearbeiten", en: "Edit Account", "pt-BR": "Editar Conta", "es-ES": "Editar cuenta" },
  account_save: { de: "Speichern", en: "Save", "pt-BR": "Salvar", "es-ES": "Guardar" },
  account_saving: { de: "Wird gespeichert…", en: "Saving…", "pt-BR": "Salvando…", "es-ES": "Guardando…" },
  ...
  account_api_hint_body: {
    ...
    "es-ES": "Abre Immich → Menú de usuario (arriba a la derecha) → Configuración de la cuenta → Claves de API → Crear una clave nueva",
  },
  ...
  bulk_sync_confirm: {
    ...
    "es-ES": (n: number) =>
      `¿Sincronizar las ${n} coincidencias de alta confianza?`,
  },
  recalculate: { de: "Neu berechnen", en: "Recalculate", "pt-BR": "Recalcular", "es-ES": "Recalcular" },
  ...
  album_new_desc: {
    ...
    "es-ES": "Se creará un álbum nuevo, se compartirá con las cuentas participantes y se añadirán las fotos automáticamente.",
  },
  album_existing_desc: {
    ...
    "es-ES": "El álbum existente se compartirá con las cuentas participantes y se añadirán las fotos que falten.",
  },
  album_create_btn: { de: "Album erstellen", en: "Create album", "pt-BR": "Criar álbum", "es-ES": "Crear álbum" },
  album_link_btn: { de: "Album verknüpfen", en: "Link album", "pt-BR": "Vincular álbum", "es-ES": "Vincular álbum" },
  album_name_ph: { de: "Album-Name…", en: "Album name…", "pt-BR": "Nome do Álbum…", "es-ES": "Nombre del álbum…" },
  dismissed_label: {
  ...
  album_linked_ok: { de: "Album verbunden!", en: "Album linked!", "pt-BR": "Álbum vinculado!", "es-ES": "¡Álbum vinculado!" },
  album_linked_err: {
  ...
  badge_names_synced: { de: "Namen sync", en: "Names synced", "pt-BR": "Nomes sincronizados", "es-ES": "Nombres sincronizados" },
  badge_album_linked: { de: "Album verbunden", en: "Album linked", "pt-BR": "Álbum vinculado", "es-ES": "Álbum vinculado" },
  canonical_name_ph: {
    de: "Gemeinsamer Name…",
    en: "Shared name…",
  ...
  sync_names_btn: { de: "Namen synchronisieren", en: "Sync names", "pt-BR": "Sincronizar nomes", "es-ES": "Sincronizar nombres" },
  sync_names_again: {
  ...
  album_update_btn: { de: "Album aktualisieren", en: "Update album", "pt-BR": "Atualizar álbum", "es-ES": "Actualizar álbum" },
  album_connect_btn: { de: "Album verbinden", en: "Link album", "pt-BR": "Vincular álbum", "es-ES": "Vincular álbum" },
  not_same_person: {
  ...
  filter_names_synced: { de: "Namen sync", en: "Names synced", "pt-BR": "Nomes sincronizados", "es-ES": "Nombres sincronizados" },
  filter_album_linked: { de: "Album verbunden", en: "Album linked", "pt-BR": "Álbum vinculado", "es-ES": "Álbum vinculado" },
  filter_dismissed: { de: "Abgelehnte", en: "Dismissed", "pt-BR": "Descartado", "es-ES": "Descartadas" },
  visible_of: {
    ...
    "es-ES": (visible: number, total: number) =>
      `${visible} de ${total} sugerencias visibles`,
  },
  match_multi_account_hint: {
    ...
    "es-ES": 'Esta coincidencia forma parte de un álbum con más de 2 cuentas. Haz los cambios desde "Álbumes" o "Ampliar coincidencia".',
  },
  no_open_matches: {
  ...
  // ── AlbumsOverview ────────────────────────────────────────────────────
  albums_title: { de: "Verwaltete Alben", en: "Managed Albums", "pt-BR": "Álbuns Gerenciados", "es-ES": "Álbumes gestionados" },
  albums_subtitle: {
    ...
    "es-ES": (n: number) =>
      `${n} ${n === 1 ? "álbum" : "álbumes"} con sincronización automática`,
  },
  sync_all: { de: "Alle synchronisieren", en: "Sync all", "pt-BR": "Sincronizar tudo", "es-ES": "Sincronizar todo" },
  linked_people: { de: "Verknüpfte Personen", en: "Linked people", "pt-BR": "Pessoa vinculada", "es-ES": "Personas vinculadas" },
  last_sync: {
  ...
  sync_now: { de: "Jetzt synchronisieren", en: "Sync now", "pt-BR": "Sincronizar agora", "es-ES": "Sincronizar ahora" },
  remove_link: { de: "Verknüpfung entfernen", en: "Remove link", "pt-BR": "Remover vínculo", "es-ES": "Eliminar vínculo" },
  auto_sync_label: { de: "Auto-Sync", en: "Auto-Sync", "pt-BR": "Auto-Sincronismo", "es-ES": "Sincronización automática" },
  auto_sync_time: {
  ...
  auto_sync_next: {
    ...
    "es-ES": (time: string, day: string) =>
      `Próxima sincronización: ${day} a las ${time}`,
  },
  ...
  albums_empty_hint: {
    ...
    "es-ES": "Crea un álbum desde una sugerencia de coincidencia o mediante una coincidencia manual.",
  },
  ...
  undo_tip: { de: "Rückgängig machen", en: "Undo action", "pt-BR": "Desfazer ação", "es-ES": "Deshacer acción" },
  log_clear: { de: "Log löschen", en: "Delete log", "pt-BR": "Excluir Log", "es-ES": "Eliminar registro" },
  log_clear_confirm: {
  ...
  action_sync_names: { de: "Namen sync", en: "Name sync", "pt-BR": "Sincronização de nomes", "es-ES": "Sincronizar nombres" },
  action_create_album: { de: "Album erstellen", en: "Create album", "pt-BR": "Criar álbum", "es-ES": "Crear álbum" },
  action_undo_names: { de: "Undo Namen", en: "Undo names", "pt-BR": "Desfazer nomes", "es-ES": "Deshacer nombres" },
  action_share_album: { de: "Album teilen", en: "Share album", "pt-BR": "Compartilhar álbum", "es-ES": "Compartir álbum" },
  action_add_assets: { de: "Assets hinzufügen", en: "Add assets", "pt-BR": "Adicionar itens", "es-ES": "Añadir elementos" },
  action_refresh: { de: "Album aktualisieren", en: "Refresh album", "pt-BR": "Atualizar álbum", "es-ES": "Actualizar álbum" },
  action_link: { de: "Album verknüpfen", en: "Link album", "pt-BR": "Vincular álbum", "es-ES": "Vincular álbum" },

  // ── ExtendMatch ───────────────────────────────────────────────────────
  extend_title: { de: "Match erweitern", en: "Extend Match", "pt-BR": "Estender Correspondência", "es-ES": "Ampliar coincidencia" },
  extend_subtitle: {
  ...
  extend_pick_album: { de: "Album wählen", en: "Select album", "pt-BR": "Selecionar álbum", "es-ES": "Seleccionar álbum" },
  ...
  extend_new_account: { de: "Neuer Account", en: "New account", "pt-BR": "Nova conta", "es-ES": "Cuenta nueva" },
  extend_new_person: { de: "Person auswählen", en: "Select person", "pt-BR": "Selecionar pessoa", "es-ES": "Seleccionar persona" },
  extend_sync_name: { de: "Namen synchronisieren", en: "Sync name", "pt-BR": "Sincronizar nome", "es-ES": "Sincronizar nombre" },
  ...
  extend_already_in: { de: "Bereits enthalten", en: "Already included", "pt-BR": "Já inserido", "es-ES": "Ya incluida" },
  extend_no_albums: {
  ...
  manual_album_owner: { de: "Album-Besitzer", en: "Album owner", "pt-BR": "Proprietário do álbum", "es-ES": "Propietario del álbum" },
  manual_hint: {
    ...
    "es-ES": 'Solo para coincidencias nuevas entre varias cuentas. Para añadir una persona a una coincidencia existente, usa "Ampliar coincidencia".',
  },
  ...
  manual_subtitle: {
    ...
    "es-ES": "Selecciona la persona correspondiente en cada cuenta configurada, asígnale un nombre compartido y, si quieres, crea un álbum compartido.",
  },
  ...
  add_person: { de: "Person hinzufügen", en: "Add person", "pt-BR": "Adicionar pessoa", "es-ES": "Añadir persona" },
  shared_name: { de: "Gemeinsamer Name", en: "Shared name", "pt-BR": "Nome compartilhado", "es-ES": "Nombre compartido" },
  shared_name_ph: { de: "z. B. Max Mustermann", en: "e.g. Max Doe", "pt-BR": "ex. Neymar Jr", "es-ES": "p. ej., Ana García" },
  create_shared_album: {
  ...
  album_name_label: { de: "Album-Name", en: "Album name", "pt-BR": "Nome do álbum", "es-ES": "Nombre del álbum" },
  run_btn: {
...
const logMessages: Record<string, Record<Lang, LogMessageFn>> = {
  ...
  log_name_synced: {
    ...
    "es-ES": (p) =>
      `Cuenta '${p.account}' – persona ${p.person} renombrada como '${p.name}'`,
  },
  ...
  log_assets_add_failed: {
    ...
    "es-ES": (p) =>
      `No se han podido añadir los elementos de '${p.account}'`,
  },
  ...
  log_assets_linked: {
    ...
    "es-ES": (p) =>
      `${p.count} elementos de '${p.account}' añadidos a '${p.album}'`,
  },
  ...
  log_assets_added_to_album: {
    ...
    "es-ES": (p) =>
      `${p.count} elementos nuevos de '${p.account}' añadidos al álbum '${p.album}'`,
  },
  log_album_not_found: {
  ...
  log_person_validation_failed: {
    ...
    "es-ES": (p) =>
      `No se ha podido validar la persona de '${p.account}'`,
  },
  ...
  log_no_new_assets_from_account: {
    ...
    "es-ES": (p) =>
      `No hay elementos nuevos de '${p.account}' (todos están ya en el álbum)`,
  },
  log_rename_failed: {
  ...
  log_album_created: {
    ...
    "es-ES": (p) =>
      `Álbum '${p.album}' creado en '${p.account}' con ${p.count} elementos`,
  },
